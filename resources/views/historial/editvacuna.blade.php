...
<div class="bg-light mt-4 border border-dark p-md-4 p-2 rounded mx-auto justify-content-evenly" style="max-width: 900px;">
    ...
    <form action="{{route('vacuna.update', $vacuna->id)}}" method="POST">
        ...
        <div class="row mt-4 mx-auto" style="max-width:800px;">
            ...
            <div class="col-md-4 mb-3">
                <input type="date" class="form-control @error('fecha_adm') is-invalid @enderror" value="{{ $vacuna->fecha_adm }}" name="fecha_adm" id="fecha_adm"
                required>
                @error('fecha_adm')
            ...
            <div class="col-md-4 mb-3">
                <input type="text" class="form-control @error('vacuna') is-invalid @enderror" value="{{ $vacuna->vacuna  }}" name="vacuna" id="vacuna"
            ...
            <div class="col-md-4 mb-3">
                <input type="text" class="form-control @error('marca') is-invalid @enderror" value="{{ $vacuna->marca  }}" name="marca" id="marca"
            ...
            <div class="col-md-4 mb-3">
                ...
                placeholder="Ingrese observaciones">{{$vacuna->obs }}</textarea>
                @error('obs')
            ...
            <div class="col-md-4 mb-3">
                <input type="date" class="form-control @error('fecha_prox') is-invalid @enderror" value="{{ $vacuna->fecha_prox }}" name="fecha_prox" id="fecha_prox"
                required>
                @error('fecha_prox')
            ...
            <div class="text-center">
                <button class="btn btn-primary">Actualizar vacuna</button>
            </div>
        </div>
    </form>
